package org.iskandarov.RestTemplateApp;

import org.iskandarov.RestTemplateApp.entities.User;
...
public class RestTemplateAppApplication {
    ...
    public static void main(String[] args) {
        RestTemplateAppApplication restTemplateAppApplication = new RestTemplateAppApplication();

        restTemplateAppApplication.getUsers();
        restTemplateAppApplication.createUser();
        restTemplateAppApplication.updateUser();
        restTemplateAppApplication.deleteUser();
        System.out.println("Итоговый код: " + restTemplateAppApplication.resultCode);
